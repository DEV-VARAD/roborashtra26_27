...
export const defaultMarkers = [
  { id: 'pulse-1', location: [18.52, 73.85], delay: 0 }, // Pune / Maharashtra (Roborashtra Hub)
  { id: 'pulse-2', location: [19.07, 72.87], delay: 0.5 }, // Mumbai
  { id: 'pulse-3', location: [28.61, 77.20], delay: 1 }, // Delhi NCR
  { id: 'pulse-4', location: [12.97, 77.59], delay: 1.5 }, // Bengaluru
  { id: 'pulse-5', location: [17.38, 78.48], delay: 2 }, // Hyderabad
]
  ...
  useEffect(() => {
    ...
    function init() {
      ...
      globe = createGlobe(canvas, {
        ...
        mapSamples: 16000,
        mapBrightness: 10,
        baseColor: [0.15, 0.22, 0.35],
        markerColor: [0.2, 0.85, 0.95],
        glowColor: [0.08, 0.16, 0.28],
        markerElevation: 0,
        markers: markers.map((m) => ({ location: m.location, size: 0.025, id: m.id })),
        arcs: [
          { from: [18.52, 73.85], to: [28.61, 77.20] },
          { from: [18.52, 73.85], to: [12.97, 77.59] },
          { from: [19.07, 72.87], to: [17.38, 78.48] },
        ],
